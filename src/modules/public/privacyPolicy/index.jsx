  ...
  return (
    <div className="privacy-policy-wrapper">
      ...
      <p>
        ...
        <br />
        <br />
        Post-ai is committed to protecting your privacy. This Privacy Policy
        explains how your personal information is collected, used, and disclosed
        by post-ai.
        <br />
        <br />
        This Privacy Policy applies to our website, https://post-ai.web.app. and
        its associated subdomains. By accessing or using our Service. you
      ...
      <ul>
        ...
        <li>
          <p>
            <b>Company:</b> When this policy mentions "Company. we. "us or "our,
            it refers to post-ai that is responsible for your information under
            this Privacy Policy.
          </p>
        </li>
        <br />
        <li>
          <p>
            <b>Country:</b> Where post-ai or the owners/founders of post-ai are
            based, in this case is Pakistan.
          </p>
        </li>
        <br />
        <li>
          <p>
            ...
            signs up to use the post-ai Service to manage the relationships with
        ...
        <li>
          <p>
            ...
            assigned a number known as an Internet protocol address. These
        ...
        <li>
          <p>
            ...
            post-ai or are under contract to perform a service on behalf of one
            of the parties.
          </p>
        </li>{" "}
        <br />
        <li>
          <p>
            <b>Personal Data:</b> Any information directly, indirectly or in
        ...
        <li>
          <p>
            <b>Service:</b> Refers to the service provided by post-ai as
        ...
        <li>
          <p>
            <b>Website:</b> Post-ai s site, which can be accessed via this URL:
            https//post-ai.web.app.
          </p>
        </li>{" "}
        <br />
        <li>
          <p>
            <b>You:</b> A person or entity that is registered with post-ai to
            use the Services.
          </p>
        </li>
      </ul>
      ...
      <p>
        We also collect information from mobile devices for better user
      ...
      <ul>
        <li>
          <p>
            <b>Camera (Pictures):</b> Granting camera permission allows the user
            to upload any picture straight from our service. You can safely deny
        ...
        <li>
          <p>
            <b>Photo Gallery (Pictures):</b> Granting photo gallery access
            allows the user to upload any picture from their photo gallery. You
            can safely deny photo gallery access for our service.
          </p>
        </li>
      </ul>
      <br />
      ...
      <p>
        ...
        or whose products or services we think may interest you. ve may also
      ...
      <p>
        ...
        and our service, database storage and management. E-mail management,
        ...
        service. we will likely share your personal information, and possibly
        some non-personal information, with these third parties to enable them
        to perform these services for us and for you.
      </p>
      <br />
      <p>
        We may share portions or Our log file data, including iP addresses. for
      ...
      <p>
        ...
        any of the purposes stated in this Policy. Note if at any time you would
      ...
      <p>
        We are incorporated in Pakistan. Information collected via our website.
      ...
      <p>
        ...
        non-disclaim able duty to protect your personal information. you agree
      ...
      <p>
        ...
        uses and disclosures of personally 1dentimable information as follows.
        You can contact us in order to
      </p>
      <br />
      <p>
        <b>(1)</b> Update or correct your personally identifiable information,
        <b> (2)</b> Change your preferences with respect to communications and
        other information you receive from us, or <b>(3)</b> Delete the
        personally identifiable information maintained about you on our systems
        (subject to the following paragraph), by canceling your account. Such
        ...
        record of the information you have provided to us from our system.
      </p>
      <br />
      <p>
      ...
      <p>
        ...
        indirectly controls, is controlled by or i5 under common control with
      ...
      <p>
        ...
        on file. We cannot, however, ensure or warrant the absolute security
        ofany information you transmit to us or guarantee that your information
      ...
      <h3>Governing Law</h3>
      <p>
        The laws of Pakistan, excluding its conflicts of law rules, shall govern
      ...
      <h3>What is GDPR?</h3>
      <p>
        GDPR I5 an EU-wide privacy and data protection law that regulates how
        ElU residents' data is protected by companies and enhances the control
      ...
      <p>
        ...
        data, biometric data, lP addresses, physical address, sexual
      ...
      <p>
        ...
        At Help Scout westrongly believe that your data privacy is very
      ...
      <p>
        ...
        vetted, DPA compliant vendors. We do store all conversation and personal
        data for up to 6 years unless your account is deleted. In which case, we
        dispose of all data in accordance with our Terms of Service and Privacy
        Policy, but we will not hold it longer than 60 days.
      </p>
      <br />
      <p>
        We are aware that you are working with EU customers. you need to be able
        ...
        start and have always given you access to your data and your customers
      ...
      <br />
      <p>
        We are also required to communicate information about nights California
      ...
      <br />
      <p>
        <b>(1)</b> Categories of Personal Information we collect, use, or share;{" "}
        <b>(2) </b>
        Purposes for which categories of Personal Information are collected or
        used by us: <b>(3)</b> Categories of sources from which we collect
        Personal Information, and <b>(4)</b> Specific pieces of Personal
      ...
      <ul>
        <li>
          <p>
            Right to Know and Access. You may submit a verifiable request for
            information regarding the: <b>(1)</b> Categories of Personal
            Information we collect, use, or share: <b>(2)</b> Purposes for which
            categories of Personal Information are collected or used by us:{" "}
            <b>(3)</b> Categories of sources from which we collect Personal
            Information, and <b>(4)</b> Specific pieces of Personal Information
      ...
      <br />
      <p>Via Email postaics021@gmail.com</p>
    </div>
  );
}
